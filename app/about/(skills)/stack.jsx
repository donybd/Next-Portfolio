  ...
  return (
		<>
			...
			<p className="text-gray-500 text-center tracking-widest md:px-5">
				...
				<span className="text-black font-bold">Kotlin</span> |{" "}
				<span className="text-black font-bold">Flutter</span> |{" "}
				<span className="text-black font-bold">Dart</span> |{" "}
				<span className="text-black font-bold">Google Cloud Platform</span> |{" "}
				<span className="text-black font-bold">Firebase</span> |{" "}
				...
				<span className="text-black font-bold">Postman</span>
			</p>
		</>
  );
}